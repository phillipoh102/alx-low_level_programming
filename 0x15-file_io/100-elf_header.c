...
/**
 *  * print_version - Prints all  the version of an ELF header.
 ...
 * @e_ident: A pointer to any array containing the ELF class.
 */
void print_entry(unsigned long int e_entry, unsigned char *e_ident)
{
 ...
 * Return: 0 on success.
 *
 * Description: If any of  the file is not an ELF File or
